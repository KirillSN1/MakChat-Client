...
import 'package:matcha/views/components/chat/chat_messages_scroll_view.dart';
...
class _ChatViewState extends State<ChatView> with TickerProviderStateMixin {
  ...
  String errorMessage = "";
  Chat? chat;
  final MessagesGroupingModel _messagesGrouper = MessagesGroupingModel();
  static const messageAnimationDuration = Duration(milliseconds: 150);
  static const messageAnimationCurve = Curves.easeOut;
          ...
          Expanded(
            child: Container(
              ...
              child: ChatMessagesScrollView(
                ...
                groups: _messagesGrouper.groups,
                controller: _scrollController,
                builder: (data, index) {
                  return TweenAnimationBuilder<double>(
                    tween: Tween(begin: 0,end: 1),
                    duration: messageAnimationDuration,
                    curve: messageAnimationCurve,
                    builder: (ctx,opacity,widget){
                      return Opacity(opacity: opacity, child: widget);
                    },
                    child: data.buildDefault(),
                  );
                },
              ),
            ),
  ...
  Future smoothScrollEnd(){
    return _scrollController.animateTo(_scrollController.position.maxScrollExtent, 
      duration: messageAnimationDuration,
      curve: messageAnimationCurve
    );
  }
